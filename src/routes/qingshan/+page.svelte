...
<div class="w-full h-[2px] bg-gradient-to-r from-transparent via-gray-300 to-transparent my-16"></div>
  ...
  <div class="w-full h-[100vh]    text-white flex flex-row gap-10 items-center justify-center px-4">
    ...
    <div class="md:w-1/2 px-4 " >
      <h2 class="text-3xl font-bold mb-4 text-title font-bakudai-md">顯慶妃與慶安妃</h2>
      <p class="py-4 text-lg bg-gray-900 border-l-4 border-amber-300 leading-relaxed">
        顯慶妃（大媽）
        生前名為華氏，是尊王的正室夫人，後因尊王有功受封，她也被敕封為「昭順夫人」，並晉封為「顯慶妃」。
        艋舺青山宮後殿主祀的就是顯慶王妃。作為尊王的配偶，她象徵柔和、庇佑與守護，信眾多向她祈求婚姻順遂、家庭和樂與子嗣平安。
        <br><br>

        慶安妃（二媽）
        出身惠安當地的一名李姓女子。相傳她與玩伴在青山宮玩耍時，立下「能把手帕丟上屋梁而不落者，未來可成為尊王夫人」的童約。
        長大後，她在準備出嫁的年紀於青山宮內坐化，後被尊為「慶安妃」。民間更常說「二媽比大媽顯」，因此早期請神時，多由二媽降乩。
      </p>
